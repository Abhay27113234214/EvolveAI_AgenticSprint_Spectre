...
class ApiClient {
    ...
    async getFallbackData(endpoint) {
        ...
        const fallbackMap = {
            ...
            '/api/query': null, // No fallback for chat
            '/api/uploadAnnualReportPdf': { success: false, message: 'Upload unavailable offline' }
        };
...
class FinancialApi extends ApiClient {
    ...
    async askQuestion(question) {
        return await this.post('/api/query', { query: question });
    }
    ...
    async uploadDocuments(files, onProgress = null) {
        ...
        return await this.upload('/api/uploadAnnualReportPdf', formData, onProgress);
    }
